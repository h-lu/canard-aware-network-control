...
| [Krupa & Touboul (2016)](https://doi.org/10.1007/s00332-015-9268-3) | Canards, mixed-mode oscillations, bursting, and delay-dependent bifurcation structure in delayed FitzHugh--Nagumo. | Primarily qualitative structure; no network transfer or certified threshold expansion. |
