#!/usr/bin/env python3
"""Generate the Stage-4U reduced-Y explicit-lambda event result atomically."""
...
def main() -> None:
    ...
    payload = build_stage4u_result(repository)
    validate_stage4u_result(payload, repository, recompute=True)
