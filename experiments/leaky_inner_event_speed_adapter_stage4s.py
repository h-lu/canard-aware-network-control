#!/usr/bin/env python3
"""Generate, validate, and atomically install the Stage-4S speed adapter."""
...
def main() -> None:
    ...
    payload = build_stage4s_event_speed_result(repository)
    validate_stage4s_event_speed_result(payload, repository, recompute=True)
