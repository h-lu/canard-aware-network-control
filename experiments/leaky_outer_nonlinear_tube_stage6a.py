#!/usr/bin/env python3
"""Generate, validate, and atomically install the Stage-6A result."""
...
def main() -> None:
    ...
    payload = build_stage6a_result(repository)
    # No temporary output is created until every parent, source lock, strict
    # inequality, and frozen numeric-core check has passed.
