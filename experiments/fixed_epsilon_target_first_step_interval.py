#!/usr/bin/env python3
"""Generate the outward-rounded target first-step cell certificate."""
...
def build_payload() -> dict[str, object]:
    ...
    return {
        "audit": json_ready_target_first_step_interval(),
        "manifest": manifest,
    }
...
def main() -> None:
    ...
    validate_target_first_step_interval_result(payload, REPOSITORY)
