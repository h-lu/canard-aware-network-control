#!/usr/bin/env python3
"""Generate or check the source-bound Stage-4B directed contract."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--check",
        action="store_true",
        help="validate the registered Stage-4B result without rewriting it",
    )
    ...
    if arguments.check:
        ...
        return
    payload = build_stage4b_contract_result(REPOSITORY)
    validate_stage4b_contract_result(payload, REPOSITORY)
