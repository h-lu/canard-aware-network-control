#!/usr/bin/env python3
"""Generate the bounded clock-positive graph-extension certificate."""
...
import canard_control.fixed_epsilon_clocked_tail_graph_extension as extension  # noqa: E402
from canard_control.fixed_epsilon_clocked_tail_graph_extension import (  # noqa: E402
    DEFAULT_COMMAND,
...
def main() -> None:
    ...
    parent_hashes, parent_checks = verify_clocked_tail_parent_evidence(
        REPOSITORY
    )
    source_path = Path(extension.__file__).resolve()
