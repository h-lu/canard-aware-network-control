#!/usr/bin/env python3
"""Generate, validate, and atomically install the Stage-4N contract."""
...
def main() -> None:
    ...
    payload = build_stage4n_result(repository)
    validate_stage4n_result(payload, repository, recompute=True)
