...
- The preparation-independent critical curve, frozen-resource
  ...
  phase/fixed-base linear level.  This does not yet give a uniform nonlinear
  normal tube, the nonlinear graph remainder, a uniform
  inverse in the old normalized state norm, higher parameter jets, a moving
