...
- The preparation-independent critical curve, frozen-resource
  ...
  It does not transport the fixed-radius RFDE inverse to that diagonal;
  the next problem is a diagonal-uniform normal/collar endpoint BVP, not a
  literal recut.  The relative phase-to-state estimate also
