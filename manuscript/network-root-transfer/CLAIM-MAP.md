...
- The preparation-independent critical curve, frozen-resource
  ...
  identity cannot be invoked.  The next problems are the second-order
  terminal $Z$ jet required for the history shear, the moving-duration
  column, and the original-endpoint family.  The
