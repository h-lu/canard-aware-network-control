...
- The preparation-independent critical curve, frozen-resource
  ...
  this anchored subspace.  This does not yet give a uniform nonlinear normal
  tube, the nonlinear delay and old-history remainders, higher parameter jets, a moving
  nonlinear tracker, a past physical history, or a physical root.  These
  results do not yet
