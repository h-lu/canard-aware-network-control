...
- The preparation-independent critical curve, frozen-resource
  ...
  flushed.  The next problem is therefore the
  rough-middle-to-incoming trace/prefix assembly, localized terminal/event
  columns, and the event-aligned $K$ correction;
