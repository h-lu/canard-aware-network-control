...
fix phase and separate the longitudinal direction
(\cref{rem:frozen-resource-phase-quotient}).  Moreover,
...
requires an independently normalized complete-history construction and the
