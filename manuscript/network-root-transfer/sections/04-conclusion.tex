...
(\cref{prop:unprepared-outer-skeleton}); its reduced critical-layer equation
also has positive truncated actions on both branches
(\cref{cor:outer-reduced-actions}).  Neither statement constructs a positive-
\(\delta\) invariant history.  Moreover,
