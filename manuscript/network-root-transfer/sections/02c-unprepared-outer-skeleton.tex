...
constructed.  A physical outer theorem must first prove a
stable--center--strong-unstable trichotomy containing that longitudinal
bundle and only then impose phase to obtain the normal stable/one-strong-
unstable splitting; the raw full frozen system does not have the latter
dichotomy.
\end{remark}
