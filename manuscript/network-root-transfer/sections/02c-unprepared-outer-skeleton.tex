...
frozen-resource voltage matrix \(\mathcal J^{\rm fv}_{N}(r)\), not the
finite-\(\delta\) RFDE spectrum;
the long delays
can create weak history modes.  Second, the action is that of the principal
