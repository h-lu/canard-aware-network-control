...
\cref{def:canonical-preparation}.  We use the datum \(\mathbf p_{\rm can}\)
...
fixed preparation are bounded, with the same parameter derivatives, by
\begin{equation}
...
algebraic remainders below.  The pairings in
